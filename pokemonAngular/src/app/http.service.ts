...
export class HttpService {
  ...
  // 1st function to get obserable
  getPokemon(){
    return this._http.get('https://pokeapi.co/api/v2/pokemon/12');
    // var arr = [];
    // // First API Call
  ...
  // 2nd function to get obserable
  getAbility(){
    return this._http.get('https://pokeapi.co/api/v2/ability');
  }
